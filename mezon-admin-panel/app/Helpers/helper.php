...
function makeSlug($string)
{
    ...
    // Checking for the existence of slugs in the slug field products table and returning the number of available slugs
...
{
    return Jalalian::fromFormat('Y/m/d H:i:s', $date)->toCarbon()->toDateTimeString();
}
...
{
    return Jalalian::fromCarbon(\Carbon\Carbon::parse($date))->format('Y/m/d H:i:s');
}

function createImageName($imageName)
{
